package com.lendico.plangenerator.exceptionhandler;
...
public class GlobalExceptionHandler extends ExceptionHandlerExceptionResolver {
	...
	public ResponseEntity<?> handleControllerException(HttpMediaTypeNotSupportedException ex, WebRequest req) {
		...
		ObjectNode errorJsonNode = LendicoUtil.createErrorJsonNode(HttpStatus.UNSUPPORTED_MEDIA_TYPE,
    ...
    public ResponseEntity<?> handleMissingServletRequestParameterException( HttpServletRequest request, 
    	...
    	String message = ExceptionUtils.getRootCauseMessage(ex);
		ObjectNode errorJsonNode = LendicoUtil.createErrorJsonNode(HttpStatus.BAD_REQUEST,
